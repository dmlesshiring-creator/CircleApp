  ...
  return (
    ...
    >
      <TouchableOpacity
        ...
        accessibilityHint="Tap to close the emoji picker"
      >
        <View
          style={{
            flexDirection: 'row',
        ...
        >
          {EMOJI_REACTIONS.map((emoji) => (
            <TouchableOpacity
              ...
              accessibilityRole="button"
              accessibilityHint="Double tap to add this reaction to the message"
            >
              <Text style={{ fontSize: 24 }} allowFontScaling={true}>{emoji}</Text>
            </TouchableOpacity>
          ))}
          ...
          <TouchableOpacity 
            ...
            accessibilityRole="button"
            accessibilityHint="Double tap to see more emoji options"
          >
